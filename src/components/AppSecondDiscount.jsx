...
const AppDiscount = () => {
	...
	return (
		<div className={window.innerWidth < 769 ?  "mx-auto relative bg-discount-mob bg-cover px-4 py-10" +
			" bg-no-repeat" : "mx-auto relative bg-discount-mob bg-cover px-4 py-10"}>
			<div className="relative z-10 pt-4 max-w-[80%] xs+:max-w-[60%] mx-auto md:max-w-[50%] ml-auto xl:pt-16">
				<h3 className="text-white font-proxima-extrabold text-4xl xs+:text-5xl md:text-4xl lg:text-6xl xl:text-7xl tracking-tighter leading-10 md:leading-8 xl:leading-[3.8rem]">Есть вопросы?</h3>
				<p className="text-white font-proxima-semibold text-2xl xs+:text-3xl md:text-2xl lg:text-3xl xl:text-5xl mt-4 xl:text-5xl ">в рабочие дни менеджер перезванивает в течение 15 мин</p>
				...
				<a href="#" className="flex gap-4 mt-4 pb-4 lg:mt-10 items-center">
					<img src={tgwhite} className="w-[50px] md:w-[40px] lg:w-[55px]" alt=""/>
					<p className="w-[80%] md:w-[50%] text-white font-proxima-regular text-lg lg:text-2xl tracking-[-1.5px] leading-6 underline-offset-4 underline under">Технический чат в Telegram. с 8 до 22 по Мск. Ежедневно.</p>
				</a>
			</div>
